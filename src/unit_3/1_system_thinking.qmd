...
## The Living City {background-video="https://www.youtube.com/embed/CrWM2lc1oRA" background-video-loop="true"}

::: {.notes}
Tell the students: "Look at this. To a computer or a traditional top-down planner, this looks like total disorder. But it isn't. It is a highly efficient, self-organizing system where thousands of individual decisions create a functional flow. This is the 'organized complexity' Jane Jacobs spoke about—and it is exactly what we struggle to represent in a static model."
:::
...
:::
::: {.column width="40%"}
![](img/batty_book1.png){height="500px" fig-alt="Michael Batty, The New Science of Cities"}
:::
::::::
...
## Jane Jacobs: Organized Complexity
* Cities are not problems of **Simplicity** (2 variables).
* Cities are not problems of **Disorganized Complexity** (millions of random variables).
...
* "The city is not a work of art... the city is a process."
